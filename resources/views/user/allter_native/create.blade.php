                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> إضافة دواء بديل </h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('user.allter_native.store')}}"
                                          method="POST"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select  name="medication_id" id="medication" class="select2 form-control">
                                                            <optgroup label=" من فضلك أختر الدواء ">
                                                                @if($MedicationArry && count($MedicationArry) > 0)
                                                               @foreach ($MedicationArry as $medication)
                                                               <option
                                                                  value="{{$medication["medication_id"] }}">{{$medication["trade_name"]}}
                                                                </option>
...
<script>
 function loadScientificName(){
    // var el_down = document.getElementById("medication").value;
    // var inputF = document.getElementById("scientific_name");
    // inputF.setAttribute('value',el_down);
